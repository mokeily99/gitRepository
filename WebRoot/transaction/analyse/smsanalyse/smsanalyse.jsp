...
<script type="text/javascript" src="<%=webpath%>/transaction/analyse/smsanalyse/smsanalyse.js"></script>
<script type="text/javascript" src="<%=webpath%>/transaction/analyse/smsanalyse/smsSendAn.js"></script>
