...
layui.config({
	...
	var layer = parent.layer === undefined ? layui.layer : parent.layer;
        ...
        form.on("submit(changeUser)",function(data){
        	...
        	/*var face=$("#userFace").val();*/
        	$.ajax({
    			url : webpath + "/personnel/updateUserInfo.action",
    			type : "post",
    			dataType : "json",
    			data : {
    				account:account,pwd:password,userName:name,userPhone:phone,userTel:tel,userAddress:address
    			},
        ...
        form.on("submit(changePwd)",function(data){
        	...
        	var maxaccept = $("#maxaccept").val();
        	
        	$.ajax({
    			url : webpath + "/personnel/modifyPassword.action",
    			type : "post",
    			dataType : "json",
    			data : {
    				newPwd : newPwd, oldPwd: oldPwd ,maxaccept : maxaccept
    			},
    			success : function(data) {
    				var resultCode = data.resultCode;
    				var resultMsg = data.resultMsg;
